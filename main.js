...
/* harmony export */   "renderTasksInHome": () => (/* binding */ renderTasksInHome),
/* harmony export */   "renderTasksInImportant": () => (/* binding */ renderTasksInImportant),
/* harmony export */   "renderTasksInToday": () => (/* binding */ renderTasksInToday),
/* harmony export */   "renderTasksInWeek": () => (/* binding */ renderTasksInWeek),
...
function countTasksInToday(tasksArray) {
  let taskCount = "";
  const todayDate = (0,date_fns__WEBPACK_IMPORTED_MODULE_0__["default"])(new Date());

  for (let i = 0; i < tasksArray.length; i++) {
    if (tasksArray[i].completed === "no") {
      const taskDueDate = (0,date_fns__WEBPACK_IMPORTED_MODULE_1__["default"])(
        tasksArray[i].dueDate,
        "MM-dd-yyyy",
        new Date()
      );
      if ((0,date_fns__WEBPACK_IMPORTED_MODULE_2__["default"])(todayDate, taskDueDate) === 0) taskCount++;
    }
  }
...
function countTasksInWeek(tasksArray) {
  let taskCount = "";
  const todayDate = (0,date_fns__WEBPACK_IMPORTED_MODULE_0__["default"])(new Date());
  const sevenDaysFromTodayDate = (0,date_fns__WEBPACK_IMPORTED_MODULE_3__["default"])(todayDate, 7);
  ...
  for (let i = 0; i < tasksArray.length; i++) {
    if (tasksArray[i].completed === "no") {
      ...
      if (
        !(
          (0,date_fns__WEBPACK_IMPORTED_MODULE_2__["default"])(taskDueDate, todayDate) === -1 ||
          (0,date_fns__WEBPACK_IMPORTED_MODULE_2__["default"])(taskDueDate, sevenDaysFromTodayDate) === 1
        )
      )
        taskCount++;
    }
...
function renderTasksInHome(tasksArray) {
...
function renderTasksInToday(tasksArray) {
  const directoryName = document.querySelector(".directoryName");
  const taskList = document.querySelector(".task_list");
  const todayDate = (0,date_fns__WEBPACK_IMPORTED_MODULE_0__["default"])(new Date());
  ...
  for (let i = 0; i < tasksArray.length; i++) {
    const taskDueDate = (0,date_fns__WEBPACK_IMPORTED_MODULE_1__["default"])(tasksArray[i].dueDate, "MM-dd-yyyy", new Date());
    if ((0,date_fns__WEBPACK_IMPORTED_MODULE_2__["default"])(todayDate, taskDueDate) === 0) {
      const taskDiv = document.createElement("div");
      taskDiv.dataset.index = i;
      taskDiv.classList.add("taskDivUI");
...
function renderTasksInWeek(tasksArray) {
  const directoryName = document.querySelector(".directoryName");
  const taskList = document.querySelector(".task_list");
  const todayDate = (0,date_fns__WEBPACK_IMPORTED_MODULE_0__["default"])(new Date());
  const sevenDaysFromTodayDate = (0,date_fns__WEBPACK_IMPORTED_MODULE_3__["default"])(todayDate, 7);
...
function renderTasksInImportant(tasksArray) {
  const directoryName = document.querySelector(".directoryName");
  const taskList = document.querySelector(".task_list");
...
function createTask(currentProject) {
  ...
  const details = document
    ...
    .value.trim();
  const dueDate = (0,date_fns__WEBPACK_IMPORTED_MODULE_0__["default"])(
...
submitTaskBtn.addEventListener("click", (e) => {
  ...
  if (currentProject) {
    ...
    (0,_UI__WEBPACK_IMPORTED_MODULE_3__.renderTasksInHome)(tasksArray);
  }
  (0,_UI__WEBPACK_IMPORTED_MODULE_3__.renderNonProjectsUI)(tasksArray);
...
function createNonProjectDirectoryEventListeners() {
  ...
  today.addEventListener("click", () => {
    currentProject = "";
    (0,_UI__WEBPACK_IMPORTED_MODULE_3__.renderTasksInToday)(tasksArray);
    closeAndResetForms();
    (0,_UI__WEBPACK_IMPORTED_MODULE_3__.hideElement)(addTaskBtn);
  });
  ...
  week.addEventListener("click", () => {
    currentProject = "";
    (0,_UI__WEBPACK_IMPORTED_MODULE_3__.renderTasksInWeek)(tasksArray);
    closeAndResetForms();
    (0,_UI__WEBPACK_IMPORTED_MODULE_3__.hideElement)(addTaskBtn);
  });
  ...
  important.addEventListener("click", () => {
    currentProject = "";
    (0,_UI__WEBPACK_IMPORTED_MODULE_3__.renderTasksInImportant)(tasksArray);
    closeAndResetForms();
    (0,_UI__WEBPACK_IMPORTED_MODULE_3__.hideElement)(addTaskBtn);
  });
}
